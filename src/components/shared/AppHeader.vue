		...
		>
			...
			>
				...
				<div class="hidden md:block">
					<Button
						title="Hire Me"
						class="text-md font-general-medium bg-emerald-700 hover:bg-emerald-700 text-white shadow-sm rounded-md px-5 py-2.5 duration-300"
						@click="showModal()"
