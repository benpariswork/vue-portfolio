...
<template>
	...
	>
		...
		>
			<button
				class="font-general-medium sm:hidden block text-left text-md font-medium bg-emerald-600 hover:bg-emerald-700 text-white shadow-sm rounded-sm px-4 py-2 mt-2 duration-500"
				@click="showModal()"
