			...
			socials: [
				{
					...
					name: 'LinkedIn',
					icon: 'linkedin',
					url: 'https://www.linkedin.com/in/benpariswork/',
				},
				{
					id: 2,
					name: 'Soundcloud',
					icon: 'github',
					url: 'https://github.com/benpariswork',
				},
				// {
				// 	id: 3,
				// 	name: 'Medium',
				// 	icon: 'book',
				// 	url: 'https://medium.com/@XXXXXXXX',
				// },
			],
		};
	},
			...
			>
				...
				<ul class="flex gap-4 sm:gap-8">
					<a
						...
						:href="social.url"
						target="__blank"
						class="text-gray-400 bg-ternary-light hover:text-indigo-500 dark:hover:text-indigo-400 cursor-pointer rounded-lg bg-gray-50 dark:bg-ternary-dark hover:bg-gray-100 shadow-sm p-4 duration-500"
					>
						<i
